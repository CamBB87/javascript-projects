...
if (fuelLevel < 1000 || engineTemperature > 3500 || engineIndicatorLight === "red blinking") { 
    console.log("OH GOD THE ENGINE IS ON FIRE!!");
} else if (fuelLevel <= 5000 || engineTemperature > 2500) { 
    console.log(`Check fuel levels. engines are a little spicy right now.`);
} else if (fuelLevel > 20000 && engineTemperature <= 2500) { 
    console.log(`Fuel level above 25%. Engines good`);
} else if (fuelLevel > 10000 && engineTemperature <= 2500){
    console.log(`fuel level above 50%. angines good`);
} else if (fuelLevel > 5000 && engineTemperature <= 2500) {
    console.log(`full tank!! engines good.`);
} else {
    console.log(`Fuel and engine were stolen.`);
};
...
if (fuelLevel > 20000 && engineIndicatorLight === !`red blinking` || commandOverride === true) {
    ...
    console.log(`DON"T PRESS THE BUTTON!!`);
};